...
|                              | ***\*CSC-161A\**** | ***\*CSC-161B\**** | ***\*CSC-162A\**** | ***\*CSC-163A\**** | ***\*CSC-163B\**** | ***\*CSC-163T（适用于T接线）\**** |
| ---------------------------- | ------------------ | ------------------ | ------------------ | ------------------ | ------------------ | --------------------------------- |
| 电流差动全线速动             |                    |                    |                    | √                  |                    |                                   |
| 纵联距离、纵联零序全线       |                    |                    |                    |                    |                    |                                   |
| 三段相间距离                 |                    |                    |                    | √                  |                    |                                   |
...
![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps15.png) 
...
![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps16.png)

2）专用方式：

![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps17.png)
...
![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps27.png)

故在昂立测试仪里，应选择K1的设置方式为：![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps28.png)，![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps29.png)。![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps30.png)取定值清单里的零序电阻补偿系数，![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps31.png)取定值清单里的零序电抗补偿系数。

值得注意的是，对于阻抗特性类似于CSL系列四边形特性的保护装置（如CSL-102B），其距离保护的各段定值包括R和X，其中，定值X的整定过程中，忽略了线路阻抗的电阻分量，即假定阻抗角为90°，则X的大小近似等于线路阻抗的幅值Z，定值R的整定主要用于避开故障的过渡电阻，几乎和线路阻抗无关，所以对于阻抗特性类似于CSL系列四边形特性时，除特殊说明外（如阻抗特性试验），一般做90°阻抗角试验：![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps32.png)

3. 对于国外的一些保护

如果定值清单中提供的是Z0/Z1，用户可根据（式7-1）计算出K1。

如果定值清单中提供的是零序电抗值、电阻值和正序电抗值、电阻值，用户可根据（式7-2）计算出![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps33.png)，![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps34.png)。

 

距离保护补偿系数的结论

![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps35.png)

结论

①当![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps36.png)时，依据![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps37.png)，此时![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps38.png)；
...
![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps39.png)

![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps40.png)
...
![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps41.png)
...
（6）***\*220kV\****以上保护的重合闸方式为***\*单相重合闸\****（开关是分相的）。
...
线路抽取电压Ux：100V或100/![img](file:///C:\Users\yuri\AppData\Local\Temp\ksohtml22920\wps42.png)
...
（3）对于利用***\*专用光纤通道\****传输保护信息的远方传输设备，应对其发信电平、收信灵敏电平进行检测，并保证通道的裕度满足运行要求。
...
（2）若同一被保护设备的各套保护装置皆接于同一电流互感器二次回路，则按回路的实际接线，自电流互感器引进的第一套保护屏的端子排上接入试验电流、电压，以检验各套保护相互间的动作关系是否正确；若同一被保护设备的各套保护装置***\*分别接于不同的电流回路\****时，则应临时将各套保护的电流回路***\*串联\****后进行整组试验。验证开关跳闸线圈极性是否正确。
